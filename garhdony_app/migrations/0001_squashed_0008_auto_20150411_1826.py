    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('done_tasks', models.ManyToManyField(related_name='Players', null=True, to=b'garhdony_app.LogisticalTask', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='sheets',
            field=models.ManyToManyField(related_name='characters', to=b'garhdony_app.Sheet', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='playercharacter',
        ...
        migrations.AlterField(
            model_name='sheet',
            name='last_printed',
            field=models.DateTimeField(default=datetime.datetime(2015, 4, 11, 16, 35, 0, 646977), null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='playerprofile',
        ...
        migrations.AlterField(
            model_name='sheet',
            name='last_printed',
            field=models.DateTimeField(default=datetime.datetime(2015, 4, 11, 16, 36, 10, 486815), null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='playerprofile',
        ...
        migrations.AlterField(
            model_name='sheet',
            name='last_printed',
            field=models.DateTimeField(default=datetime.datetime(2015, 4, 11, 16, 42, 25, 788852), null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='playerprofile',
        ...
        migrations.AlterField(
            model_name='sheet',
            name='last_printed',
            field=models.DateTimeField(default=datetime.datetime(2015, 4, 11, 18, 24, 25, 930885), null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='playerprofile',
        ...
        migrations.AlterField(
            model_name='sheet',
            name='last_printed',
            field=models.DateTimeField(default=datetime.datetime(2015, 4, 11, 18, 26, 23, 665017), null=True),
            preserve_default=True,
        ),
    ]
